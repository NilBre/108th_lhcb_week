...
from Humboldt.AlignmentScenarios import configureVPModuleAlignment, configureVPHalfAlignment, configureGlobalAlignment_v10
config = configureGlobalAlignment_v10(halfdofs="TxTyTz")
