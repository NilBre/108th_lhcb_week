...
from Humboldt.AlignmentScenarios import configureVPModuleAlignment, configureVPHalfAlignment, configureGlobalAlignment_v6_3
config = configureGlobalAlignment_v6_3(halfdofs="TxTyTz")
