...
def plot(data_arr, outname, run_labels, layer_names, title_label):
    ...
    for i in range(total_num_runs):
        ...
        plt.savefig(f'{outname_prefix}{outfiles}' + run_labels[i] + '_' + outname + '.pdf')
...
plot(tx_data, 'tx_all_runs', legendlabels, layers, 'Tx')
plot(ty_data, 'ty_all_runs', legendlabels, layers, 'Tz')
